...
test: $(VCS_SIM_PREREQ) hex gen_ovpsim_ic
	@echo "=================== ycli mk/uvmt/vcs.mk : make test"
	@echo "=================== ycli DPI_DASM_LIB   : $(DPI_DASM_LIB)"
	@echo "SIM_RESULTS is $(SIM_RESULTS)"
	mkdir -p $(SIM_RUN_RESULTS)
	cd $(SIM_RUN_RESULTS) && \
...
ifneq ($(call IS_NO,$(COMP)),NO)
@echo "=== ycli mk/uvmt/vcs.mk: is no comp "
VCS_COMPLIANCE_PREREQ = comp build_compliance
endif

compliance: $(VCS_COMPLIANCE_PREREQ)
	@echo "=== ycli mk/uvmt/vcs.mk: make compliance "
